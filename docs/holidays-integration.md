...
- [Обзор](#обзор)
- [Изменения в markdown-org-extract](#изменения-в-markdown-org-extract)
    - [Новый CLI аргумент](#новый-cli-аргумент)
    - [Доступные годы](#доступные-годы)
    - [Реализация](#реализация)
- [Изменения в markdown-org-vscode](#изменения-в-markdown-org-vscode)
    - [Получение праздников](#получение-праздников)
    - [Передача в AgendaPanel](#передача-в-agendapanel)
    - [Использование в WebView](#использование-в-webview)
- [Тестирование](#тестирование)
    - [Unit тесты](#unit-тесты)
- [Преимущества](#преимущества)
- [Обновление данных о праздниках](#обновление-данных-о-праздниках)
- [Fallback](#fallback)
