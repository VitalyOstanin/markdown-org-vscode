...
suite('resolveHeadingClass', () => {
    test('DEADLINE without priority -> deadline-heading', () => {
        assert.strictEqual(
            resolveHeadingClass({ timestamp_type: 'DEADLINE' }),
            'deadline-heading'
        );
    });
    ...
    test('DEADLINE wins over priority A', () => {
        ...
        assert.strictEqual(
            resolveHeadingClass({ timestamp_type: 'DEADLINE', priority: 'A' }),
            'deadline-heading'
        );
    });
    ...
    test('DEADLINE wins over priority B / C too', () => {
        assert.strictEqual(
            resolveHeadingClass({ timestamp_type: 'DEADLINE', priority: 'B' }),
            'deadline-heading'
        );
        assert.strictEqual(
            resolveHeadingClass({ timestamp_type: 'DEADLINE', priority: 'C' }),
            'deadline-heading'
        );
    });
    ...
    test('priority A without DEADLINE -> heading-priority-a', () => {
        assert.strictEqual(
            resolveHeadingClass({ priority: 'A' }),
            'heading-priority-a'
        );
    });
    ...
    test('priority B / C without DEADLINE -> matching class', () => {
        assert.strictEqual(
            resolveHeadingClass({ priority: 'B' }),
            'heading-priority-b'
        );
        assert.strictEqual(
            resolveHeadingClass({ priority: 'C' }),
            'heading-priority-c'
        );
    });
    ...
    test('SCHEDULED with priority -> priority class wins (no DEADLINE)', () => {
        ...
        assert.strictEqual(
            resolveHeadingClass({ timestamp_type: 'SCHEDULED', priority: 'A' }),
            'heading-priority-a'
        );
    });
    ...
    test('CLOSED / CREATED do not override priority', () => {
        ...
        assert.strictEqual(
            resolveHeadingClass({ timestamp_type: 'CLOSED', priority: 'B' }),
            'heading-priority-b'
        );
        assert.strictEqual(
            resolveHeadingClass({ timestamp_type: 'CREATED', priority: 'C' }),
            'heading-priority-c'
        );
    });
});
