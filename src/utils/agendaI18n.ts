...
export interface AgendaStrings {
     ...
     * cell adds when its date has gone by with work still on it, the word it
     * adds when a deadline on a date still ahead is close enough to warn
     * about, and the section wording (`{0}` = the counted noun).
     */
    countChip: { tasks: string[]; overdue: string; due: string; inSection: string };
...
const RU: AgendaStrings = {
    ...
    tagCaption: 'Тег файла',
    tagButton: 'Тег: {0}',
    tagAll: 'ВСЕ',
    tagAllTitle: 'Показывать задачи из всех файлов',
    tagFilterTitle: 'Только файлы с тегом {0}',
    collectionChipTitle: 'Показать или скрыть задачи коллекции {0}',
    ...
    git: {
        ...
        clean: 'чисто',
        cleanTitle: 'Все файлы-источники агенды в коммитах и отправлены',
        uncommittedTitle: 'без коммита: {0}',
        ...
        unpushedGroup: 'Не отправлено: {0}',
        unpushedGroupDetailed: 'Не отправлено: {0} в {1} ({2} → {3})',
        cleanGroup: 'Чисто: {0}',
        ...
        markClean: 'В коммите и отправлен',
        ...
        commitForeignConfirm: 'Создать коммит со всем',
