...
export function activate(context: vscode.ExtensionContext) {
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('markdown-org.showAgendaDay', (date?: string) =>
            showAgenda(context, 'day', date)
        ),
        vscode.commands.registerCommand('markdown-org.showAgendaWeek', (date?: string) =>
            showAgenda(context, 'week', date)
        ),
        vscode.commands.registerCommand('markdown-org.showAgendaMonth', (date?: string) =>
            showAgenda(context, 'month', date)
        ),
        vscode.commands.registerCommand('markdown-org.showTasks', (date?: string) =>
            showAgenda(context, 'tasks', date)
        ),
